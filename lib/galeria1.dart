...
class BotonBarraNavegacion1 extends StatefulWidget {
  @override
  _BotonBarraNavegacion1State createState() => _BotonBarraNavegacion1State();
}

class _BotonBarraNavegacion1State extends State<BotonBarraNavegacion1> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      backgroundColor: Colors.white,
       appBar: AppBar(
            title: Text("Selecciona una  recetass1"),
          ),
